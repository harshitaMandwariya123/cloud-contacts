        ...
        if(line_chart_element) {
            ...
            var line_chart = c3.generate({
                ...
                data: {
                    x : 'x',
                    columns: [
                        ['x', 'Patel Motors', 'Sanghi Brothers', 'Patwa Motors', 'Harsh Motors', 'Abhikaran Motors', 'Doshi Motors', 'Khandelwal Motors', 'Rajpal Motors', 'Kasliwal Motors', 'Surjeet Motors'],
                        ['Resolution Time', 30, 25, 44, 14, 61, 74, 9, 51, 49, 91],
...
$("#modal_escalation, #modal_dealer, #modal_aggregate").on('shown.bs.modal', function(){
    С3LinesAreas.init();
});